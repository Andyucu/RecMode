...
public interface ISettingsService
{
    ...
    /// <summary>True after <see cref="Load"/> if no settings file existed yet (a fresh install/portable copy),
    /// so callers can apply one-time, hardware-derived defaults (e.g. microphone-presence) without overriding
    /// a returning user's explicit choices.</summary>
    bool IsFirstRun { get; }
